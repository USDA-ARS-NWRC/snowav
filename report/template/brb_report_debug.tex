...
\begin{table}[h!]
	...
	\begin{tabular}{l c c  }
		...
		\midrule
		Boise River Basin			& \VAR{TOTALPRE_PM|e} 		& $\sim$\VAR{TOTAL_RAT|e}  	\\
		Featherville	    		& \VAR{SUB1PRE_PM|e}		& $\sim$\VAR{SUB1_RAT|e} 	\\
		Twin Springs   				& \VAR{SUB2PRE_PM|e}		& $\sim$\VAR{SUB2_RAT|e} 	\\
		Mores Creek	        		& \VAR{SUB3PRE_PM|e}		& $\sim$\VAR{SUB3_RAT|e} 	\\
		\bottomrule
	\end{tabular}
	% \caption{yupperdep}
	\label{tab:snotel2}
...
\begin{table}[h!]
	...
	\begin{tabular}{l c c }
		...
		\midrule
		Boise River Basin			& 858 		& 3187  	\\
		Featherville	    		& 1290		& 3139	\\
		Twin Springs   				& 1000		& 3180 	\\
		Mores Creek	        		& 941		& 2467 	\\
		\bottomrule
	\end{tabular}
	% \caption{yupperdep}
	\label{tab:snotel2}
