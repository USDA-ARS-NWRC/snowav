...
%		
%		\midrule
%	    Lakes					& \VAR{TOTALPRE_PM} 		& $\sim$\VAR{TOTAL_RAT}  	\\
%		\bottomrule
%	\end{tabular}
%	% \caption{yupperdep}
%	\label{tab:snotel2}
...
\begin{table}[h!]
	...
	\begin{tabular}{l c c c c c c }
		...
		\midrule
		Lakes				& \VAR{TOTAL_SWE|e} & \VAR{TOTAL_SWE_AV|e} & \VAR{TOTAL_PM|e} 	& \VAR{TOTAL_SWEDEL|e} & \VAR{TOTAL_SWI|e}  \\
...
\begin{figure}[htbp]
	\begin{centering}
		...
		\caption{Water year total SWE (left), SWI (right) volumes created from the hybrid model input approach. SWE and SWI values prior to November 19 are not shown. \textbf{NOTE: Total SWI values do NOT include SWI prior to November 20 in this figure.}}
		\label{fig:TOTALS}
	\end{centering}
\end{figure}
