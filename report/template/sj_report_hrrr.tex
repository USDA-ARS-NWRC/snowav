...
\begin{table}[h!]
	...
	\begin{tabular}{l c c c c c }
		...
		\multirow{2}{*} {\bf{Basin} }	& SWE & SWE (avail) & SWE (mean) & $\Delta$SWE \\ & [\VAR{VOLLBL}] & [\VAR{VOLLBL}] & [\VAR{DEPLBL}] & [\VAR{VOLLBL}]	\\
		
		\midrule
		San Joaquin				& \VAR{TOTAL_SWE|e} & \VAR{TOTAL_SWE_AV|e} & \VAR{TOTAL_PM|e} 	& \VAR{TOTAL_SWEDEL|e}  \\
		Main	    			& \VAR{SUB3_SWE|e}	& \VAR{SUB3_SWE_AV|e}  & \VAR{SUB3_PM|e} 	& \VAR{SUB3_SWEDEL|e} 	\\
		South Fork	   			& \VAR{SUB2_SWE|e}	& \VAR{SUB2_SWE_AV|e}  & \VAR{SUB2_PM|e} 	& \VAR{SUB2_SWEDEL|e}  	\\
		Jose Creek	        	& \VAR{SUB1_SWE|e}	& \VAR{SUB1_SWE_AV|e}  & \VAR{SUB1_PM|e} 	& \VAR{SUB1_SWEDEL|e} 	\\
	    Willow Creek	        & \VAR{SUB4_SWE|e}	& \VAR{SUB4_SWE_AV|e}  & \VAR{SUB4_PM|e} 	& \VAR{SUB4_SWEDEL|e} 	\\
		\bottomrule
	\end{tabular}
	\label{tab:snotel}
\end{table}
...
\begin{centering}
	% \hspace*{-.7in}
	\includegraphics[width=0.80\textwidth]{\VAR{FIG_PATH}\VAR{RESULTS_FIG}}
...
\begin{centering}	
	% \hspace*{-.7in}
	\includegraphics[width=0.80\textwidth]{\VAR{FIG_PATH}\VAR{ELEV_FIG}}
...
%	\begin{centering}	
%		% \hspace*{-.7in}
%		\includegraphics[width=0.88\textwidth]{\VAR{FIG_PATH}\VAR{DETAIL_FIG}}
%		\caption{Mean depth of SWE as a function of elevation band.}
%		\label{fig:DETAIL}
%	\end{centering}
%\end{figure}
...
%	\begin{centering}	
%		% \hspace*{-.7in}
%		\includegraphics[width=0.88\textwidth]{\VAR{FIG_PATH}\VAR{DENSITY_FIG}}
%		\caption{Current snow density, as a depth (left) and as a function of elevation band (right).}
%		\label{fig:RESULTS}
%	\end{centering}
%\end{figure}
...
\begin{figure}[htbp]
	\begin{centering}	
		...
		\caption{Model validation with measured SWE at select locations in the domain. The black line is SWE
			measured by the pillow, and blue lines are model results for the surrounding pixels. Model SWE values generated from hybrid HRRR inputs begin on Nov 19.}
		\label{fig:RESULTS}
	\end{centering}
\end{figure}
...
%	\begin{centering}	
%		% \hspace*{-.7in}
%		\includegraphics[width=0.88\textwidth]{\VAR{FIG_PATH}\VAR{DENSITY_SWE_FIG}}
%		\caption{Modeled snow density as a function of SWE, colored by elevation.}
%		\label{fig:RESULTS}
%	\end{centering}
%\end{figure}
...
\begin{figure}[htbp]
	\begin{centering}
		...
		\caption{Water year total SWE (left), SWI (right) volumes created from the hybrid model input approach. SWE and SWI values prior to November 19 are not shown. \textbf{NOTE:} Total SWI values begin on Nov. 19, 2017, and do \textbf{NOT} include SWI prior to then.}
		\label{fig:TOTALS}
	\end{centering}
\end{figure}
