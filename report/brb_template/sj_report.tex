...
\begin{table}[h!]
	...
	\begin{tabular}{l c c  }
		...
		Main	    				& \VAR{SUB1PRE_PM|e}		& $\sim$\VAR{SUB1_RAT|e} 	\\
		South Fork	   					& \VAR{SUB2PRE_PM|e}		& $\sim$\VAR{SUB2_RAT|e} 	\\
		Jose Creek	        		& \VAR{SUB3PRE_PM|e}		& $\sim$\VAR{SUB3_RAT|e} 	\\
		\bottomrule
	\end{tabular}
	% \caption{yupperdep}
	\label{tab:snotel2}
...
\begin{table}[h!]
	...
	\begin{tabular}{l c c c c c c }
		...
		Main	    			& \VAR{SUB1_SWE|e}	& \VAR{SUB1_SWE_AV|e}  & \VAR{SUB1_PM|e} 	& \VAR{SUB1_SWEDEL|e} & \VAR{SUB1_SWI|e}		\\
		South Fork	   			& \VAR{SUB2_SWE|e}	& \VAR{SUB2_SWE_AV|e}  & \VAR{SUB2_PM|e} 	& \VAR{SUB2_SWEDEL|e} & \VAR{SUB2_SWI|e} 	\\
		Jose Creek	        	& \VAR{SUB3_SWE|e}	& \VAR{SUB3_SWE_AV|e}  & \VAR{SUB3_PM|e} 	& \VAR{SUB3_SWEDEL|e} & \VAR{SUB3_SWI|e}	 	\\
		\bottomrule
	\end{tabular}
	\label{tab:snotel}
\end{table}
