...
\begin{table}[h!]
	...
	\begin{tabular}{l c c c c c }
		...
		\midrule
		San Joaquin	& \VAR{TOTAL_SWI|e} & \VAR{TOTAL_MEL|e}  & \VAR{TOTAL_RAI|e} & \VAR{TOTAL_RAT|e}  \\
		Main	    & \VAR{SUB3_SWI|e}	& \VAR{SUB3_MEL|e}  &  \VAR{SUB3_RAI|e} & \VAR{SUB3_RAT|e} \\
		South Fork 	& \VAR{SUB2_SWI|e}	& \VAR{SUB2_MEL|e}  & \VAR{SUB2_RAI|e} & \VAR{SUB2_RAT|e} \\
		Jose Creek	& \VAR{SUB1_SWI|e}	& \VAR{SUB1_MEL|e}  & \VAR{SUB1_RAI|e} & \VAR{SUB1_RAT|e} \\
		\bottomrule
	\end{tabular}
	% \caption{yupperdep}
	\label{tab:snotel2}
