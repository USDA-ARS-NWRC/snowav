...
Water Year \VAR{WATERYEAR} \\ \VAR{START_DATE} to \VAR{END_DATE} \\ \VAR{FORE_TITLE} }
...
\maketitle
{
	...
	% \node [shift={(-18.2cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=1.25cm]{\VAR{JPLLOGO}}};
	\node [shift={(-19cm,-2.0cm)}] at (current page.north east) {\includegraphics[height=2.85cm]{\VAR{ASOLOGO}}};
...
% \clearpage
% \section*{Snow Depth Update}
% \begin{figure}[htbp]
% \begin{centering}
% 	\includegraphics[width=0.88\textwidth]{/home/markrobertson/wkspace/results/tuol/wy19/ops/tuol_wy2019_ops_albfix_flt_20190428_20190513/tuol_wy2019_flt_20190504.png}
% 	\caption{Change in SWE as a result of the snow depth update, as a depth (left) and as a function of elevation band (right).}
% \end{centering}
% \end{figure}
% \clearpage
...
\noindent
\footnotesize{
Published: \VAR{REPORT_TIME}, v\VAR{VERSION}
}
\end{document}
