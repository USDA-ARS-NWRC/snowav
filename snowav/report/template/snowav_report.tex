...
\maketitle
{
	...
	\node [shift={(-18cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=1.25cm]{\VAR{JPLLOGO}}};
	\node [shift={(-10.75cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=2.85cm]{\VAR{ASOLOGO}}};
  \node [shift={(-2.2cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=1.55cm]{\VAR{ARSLOGO}}};
