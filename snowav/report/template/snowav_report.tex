...
\maketitle
{
	...
	\node [shift={(-18.5cm,-2.0cm)}] at (current page.north east) {\includegraphics[height=2.85cm]{\VAR{ASOLOGO}}};
  \node [shift={(-2.2cm,-1.75cm)}] at (current page.north east) {\includegraphics[height=1.5cm]{\VAR{ARSLOGO}}};
