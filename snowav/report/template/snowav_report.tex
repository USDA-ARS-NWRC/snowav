...
\maketitle
{
	...
	\node [shift={(-10.5cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=2.85cm]{\VAR{ASOLOGO}}};
  \node [shift={(-2.2cm,-1.5cm)}] at (current page.north east) {\includegraphics[height=1.5cm]{\VAR{ARSLOGO}}};
