...
def density(snow):
    ...
    density = snow.outputs['density'][ixe]
    ...
    dvalue = copy.deepcopy(density) - snow.outputs['density'][ixs]

    zf = snow.outputs['swe_z'][ixe] == 0
    dvalue[zf] = np.nan
    ...
    nsub = 100
    depth  = copy.deepcopy(snow.outputs['depth'][ixe])
    density = cvalue
    swe = copy.deepcopy(snow.outputs['swe_z'][ixe])
